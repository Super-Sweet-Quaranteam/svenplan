...
function Navbar(props) {
    ...
    return (
        <nav className="nav-wrapper">
            <ul className="nav">
                <li className="nav-item"><Link to='/home' className="nav-link"><img src="/images/square-logo.png" alt="logo" height="80px" /></Link></li>
                <li className="nav-item"><Link to='create-workflow' className="nav-link">Create Workflow</Link></li>
